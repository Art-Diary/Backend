...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public ResponseEntity<?> opMessageException(ArtDiaryException artDiaryException) {
		HttpHeaders headers = new HttpHeaders();
		headers.set("Content-Type", "application/json");
		return new ResponseEntity<>(new ApiErrorView(artDiaryException),
			headers,
			artDiaryException.getStatus());
	}
